...
class _TurnCombatScreenState extends State<TurnCombatScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final compact = LandscapeLayout.uiScaleOf(context) < 0.85;
      ...
      children: [
          Stack(
            children: [
              ...
              Positioned(
                right: LandscapeLayout.sp(context, 8),
                top: 0,
                bottom: 0,
                child: Center(
                  child: GameButton(
            ...
            child: sideBySide
                ? Row(
                    ...
                    children: [
                      Expanded(
                        flex: 3,
                        child: _battleColumn(enc, compact, targetId, registry),
                      ),
          ...
          SizedBox(
            ...
            child: LayoutBuilder(
              builder: (context, constraints) {
                final execPreferred =
                    CombatLayoutConstants.executeButtonWidthFor(context);
