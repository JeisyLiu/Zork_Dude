...
class GameUiSkinData {
  ...
  static const fantasy = GameUiSkinData(
    ...
    progressFill: GameUiAssets.mistHpInner,
    progressBorder: GameUiAssets.mistHpTube,
    progressFillSmall: GameUiAssets.mistHpInnerSmall,
    progressBorderSmall: GameUiAssets.mistHpTubeSmall,
  ...
  /// Layer look with Mist Tower HP tube for combat readability.
